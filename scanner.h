...
typedef enum {
    ...
    TOKEN_KUWIT, TOKEN_TULDOK, TOKEN_BAWAS, TOKEN_DAGDAG,
    TOKEN_TULDOK_KUWIT, TOKEN_PAHILIS, TOKEN_BITUIN,
    ...
    TOKEN_KUNG, TOKEN_MALI, TOKEN_MULA, TOKEN_NGUNIT_KUNG, 
    TOKEN_NULL, TOKEN_O, TOKEN_TAMA, TOKEN_URI,
